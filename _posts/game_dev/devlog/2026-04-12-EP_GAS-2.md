---
title:  "[UE5] 익스트랙션 슈터 4-2. TakeDamage를 버리다"
...
[← 4-1. GAS 도입: ASC는 PlayerState에 둔다](/devlog/EP_GAS-1)
{: .notice--info}
...
<details markdown="1">
<summary>3단계까지의 사망, 대미지 경로 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>절삭이 일어나는 대입 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>IncomingDamage 선언 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>PreAttributeChange (접기/펼치기)</summary>
...
<details markdown="1">
<summary>PostGameplayEffectExecute (접기/펼치기)</summary>
...
<details markdown="1">
<summary>GE_Damage 설정 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>ApplyGEDamage (접기/펼치기)</summary>
...
<details markdown="1">
<summary>ASC를 얻는 두 방법 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>ConfirmHitscan 뒤 한 줄 교체 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>ActivationOwnedTags와 GE GrantedTags (접기/펼치기)</summary>
...
<details markdown="1">
<summary>GE_State_Dead 설정 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>GA_Death 생성자 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>GA_Death::ActivateAbility (접기/펼치기)</summary>
...
<details markdown="1">
<summary>DefaultAbilities 부여 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>Attribute 변경 델리게이트 등록 (접기/펼치기)</summary>
