---
title:  "[UE5] 익스트랙션 슈터 5-1. 데드코드였던 아이템 계층 되살리기"
...
- `Outer`를 누구로 잡을지
- 수명은 누가 관리하는지
- 복제되는지, 서브오브젝트 등록은 어디서 하는지
- 인벤토리 엔트리에서 어떻게 참조하는지 (포인터? 핸들?)
...
<details markdown="1">
<summary>FEPItemState (접기/펼치기)</summary>
...
<details markdown="1">
<summary>InitState 기본/오버라이드 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>IsDataValid (접기/펼치기)</summary>
...
<details markdown="1">
<summary>Initialize (접기/펼치기)</summary>
...
<details markdown="1">
<summary>초기 구현: 버그 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>핸들이 null이 되는 엔진 경로 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>서브클래스가 다른 타입을 반환하던 코드 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>구워진 태그를 읽는 지점 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>에디터 스캔 필터 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>타입 쌍당 한 번만 남는 경고 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>파일에서 직접 태그 확인 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>콘솔 커맨드 두 개 (접기/펼치기)</summary>
