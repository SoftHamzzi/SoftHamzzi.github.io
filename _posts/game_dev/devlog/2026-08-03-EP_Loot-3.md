---
title:  "[UE5] 익스트랙션 슈터 5-3. F가 딱 한 번만 먹힌다"
...
<details markdown="1">
<summary>IEPInteractable (접기/펼치기)</summary>
...
<details markdown="1">
<summary>Target 필드와 서버 RPC 시그니처 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>Input_Interact (접기/펼치기)</summary>
...
<details markdown="1">
<summary>NetExecutionPolicy (접기/펼치기)</summary>
...
<details markdown="1">
<summary>클라 인스턴스의 즉시 종료 (접기/펼치기)</summary>
...
**그런데도 `LocalPredicted`가 아니면 동작하지 않는다.** `ServerOnly`나 `ServerInitiated`면 클라에서 `AbilitySystemComponent_Abilities.cpp:1755`가 **RPC를 보내기도 전에** `return false`한다. 정책이 곧 "서버로 갈지"의 스위치다.
...
<details markdown="1">
<summary>AbilityTriggers 등록 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>느낌표가 빠진 버그 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>가드가 증상을 가린 지점 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>서버 판정 5단계 (접기/펼치기)</summary>

```
0. IsNetAuthority() 아니면 즉시 EndAbility
1. Target이 유효한지 (IsValid && !IsActorBeingDestroyed)
2. Target이 IEPInteractable을 구현하는지       ← 아무 액터나 보낼 수 있다
3. ★ 거리 재검증
     DistSq <= (InteractRange + ServerRangeTolerance)^2
4. ★ CanInteract(Interactor, OutReason) == true인지
5. OnInteract(Interactor, OutReason)이 true를 돌려줬는지
...
<details markdown="1">
<summary>bClaimed 필드 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>컴포넌트에 남긴 사거리 값 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>탐지 틱 설정 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>BeginPlay 실행 조건 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>첫 스폰이 통과하는 순서 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>NotifyControllerChanged 선언 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>훅 오버라이드 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>기본 응답을 심는 지점 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>ini 채널 등록과 한 줄 오픈 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>중복 채널 처리 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>InteractPrompt (접기/펼치기)</summary>
...
<details markdown="1">
<summary>현재 도달 불가능한 회색 갈래 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>포커스가 바뀔 때만 갱신 (접기/펼치기)</summary>
