---
title:  "[UE5] 익스트랙션 슈터 5-2. 바닥에 아이템 뿌리기"
...
<details markdown="1">
<summary>FEPLootEntry (접기/펼치기)</summary>
...
<details markdown="1">
<summary>공개 API와 내부 함수 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>가중치 롤의 전형적인 형태 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>포인터 하나로 셋을 닫는 코드 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>IsDataValid로 앞당긴 검증 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>final을 붙인 GetPrimaryAssetId (접기/펼치기)</summary>
...
<details markdown="1">
<summary>CreateEditorOnlyDefaultSubobject (접기/펼치기)</summary>
...
<details markdown="1">
<summary>루트가 null일 때의 폴백 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>엔진 TargetPoint의 형태 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>HandleMatchHasStarted (접기/펼치기)</summary>
...
<details markdown="1">
<summary>복제되는 필드와 안 되는 필드 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>GetLifetimeReplicatedProps (접기/펼치기)</summary>
...
<details markdown="1">
<summary>두 경로에서 부르는 ApplyVisual (접기/펼치기)</summary>
...
<details markdown="1">
<summary>데디케이티드 서버 조기 반환 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>PrimitiveComponent 기본 프로파일 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>전 채널을 닫는 설정 (접기/펼치기)</summary>
...
## 4. Dormancy: 멀어져도 안 사라지는 이유

바닥 아이템이 수백 개인 게임이다. 매 프레임 복제 후보에 오르면 안 된다.

<details markdown="1">
<summary>Dormancy 설정 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>IsDormInitialStartupActor (접기/펼치기)</summary>
...
<details markdown="1">
<summary>UActorChannel::CleanUp (접기/펼치기)</summary>
...
<details markdown="1">
<summary>같은 프레임 안에서의 초기화 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>CDO 생성 시점의 동기 로드 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>소프트 포인터는 로드하지 않는다 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>소비 지점의 폴백 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>출력이 없는 커맨드 (접기/펼치기)</summary>
...
F키로 줍는다. 상호작용 인터페이스, 어빌리티로 갈지 서버 RPC로 갈지, 그리고 **F가 딱 한 번만 먹히는 버그**가 5-3편이다.
