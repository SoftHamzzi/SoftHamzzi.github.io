---
title:  "[UE5] 익스트랙션 슈터 4-1. GAS 도입: ASC는 PlayerState에 둔다"
...
<details markdown="1">
<summary>3단계에서 직접 관리하던 HP (접기/펼치기)</summary>
...
<details markdown="1">
<summary>Build.cs 모듈 추가 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>InitGlobalData 호출 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>서버, 클라 양쪽의 InitAbilityActorInfo 호출 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>Character가 들고 있는 캐시 포인터 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>AttributeSet 선언 (접기/펼치기)</summary>
...
<details markdown="1">
<summary>복제 등록과 OnRep (접기/펼치기)</summary>
...
<details markdown="1">
<summary>NativeGameplayTags 선언과 정의 (접기/펼치기)</summary>
...
| 상황 | 원인 | 해결 |
|---|---|---|
| 클라 ASC가 null, 어빌리티 활성화 실패 | `OnRep_PlayerState`에서 `InitAbilityActorInfo` 누락 | 서버와 클라 양쪽에서 호출 |
